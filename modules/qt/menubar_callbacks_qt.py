...
def build_menubar_callbacks(mw) -> dict:
    ...
    return {
        ...
        "batch_metadata":           mw._batch_metadata,
        ...
        "show_straighten_viewer":        mw._straighten_selected_image,
        "straighten":                    mw._straighten_btn_action,
        "deskew_selected":               lambda: _deskew_selected_qt(mw._deskew_callbacks()),
        "show_clone_zone_viewer":        mw._clone_selected_image,
        "clone_zone":                    mw._clone_selected_image,
        "show_text_viewer":              mw._text_selected_image,
        "text":                          mw._text_selected_image,
        ...
        "show_distillat_dialog":     mw._show_distillat_dialog,
        "export_piqad_font":         mw._export_piqad_font,
        "export_tengwar_fonts":      mw._export_tengwar_fonts,
        "save_all_icons":            mw._save_all_icons,
