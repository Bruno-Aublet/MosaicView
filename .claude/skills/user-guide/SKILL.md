...
**Pourquoi par position et pas par contenu** (bug corrigé le 2026-07-16) : l'ancienne détection cherchait `"Claude" in para` pour identifier le paragraphe d'attribution. Ça marche pour toutes les langues qui gardent les noms propres en lettres latines (y compris le klingon pIqaD), mais **pas pour `sjn-tengwar`/`qya-tengwar`, où tout le texte — noms propres compris — est transcrit en glyphes tengwar (plage Unicode privée)**. Le paragraphe n'était alors jamais reclassé ni retraduit et restait figé dans la langue précédente (texte + police).
